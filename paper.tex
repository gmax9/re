...
\begin{comment}
% Since no definitive "ground truth" exists for attributing darknet traffic to their root causes, 
% method assessments must rely on alternative approaches to validate detection outputs. 
% For our survey, we examined how prior works establish the "meaningfulness" of their results by 
% focusing on two main aspects of their validation approaches:
% whether they cross-reference external datasets and the scale of their validation efforts.
\end{comment}
...
\subsubsection{Internal Validation Approaches}
asdfafds

\subsubsection{Weak External Validation Approaches}
asdfdsaf

\subsubsection{Strong External Validation Approaches}
asdf
