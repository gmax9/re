...
\begin{abstract}
Analysis of network telescope traffic has provided researchers and practitioners insight into Internet-wide activities for decades.
...
Yet, \dots
In this report, we survey these frameworks \dots
\end{abstract}
...
malicious scanning, residual backscatter from DoS attacks, widespread outages, and non-trivial network misconfigurations.
