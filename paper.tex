...
% Beyond the diversity represented by these methodologies, many of them have been developed, implemented, and assessed independently by different research groups without a uniform standard for best-practices.
% As we experienced while developing our prior work~\cite{2024gao}, this poses several challenges that limit development of new and existing methodologies.
...
Section 2 introduces our taxonomy of detection methodologies with a breakdown of their detected activities, employed techniques, and the features and representations of their traffic inputs alongside 
...
Shown in Figure~\ref{fig:cov_assess}, 
the combined range of timeframes covered by darknet-traffic datasets span the start of 2012 and extend until late 2023. 
The proportion covered over this range by at least a single assessment dataset (at a daily granularity) sits at 68\%. 
...
A majority of works do not provide clear rationale for their timeframe selection, thus we infer that selection is largely opportunistic and based on availability of darknet traffic data at the time of assessment. 
...
In addition to Mirai, Figure~\ref{fig:cov_assess} plots the start date of X additional events (Table~\ref{@}), observable in darknet traffic, identified as either major vulnerabilities or scans by botnets.
...
\begin{table}[ht!]
    \caption{Historic landmark events associated with Internet-wide traffic either purported or confirmed observed by darknets.}
    \label{tab:events}
    \centering
    \begin{tabular}{lll : lll}
    \hline
    \textbf{ID} & \textbf{Event Name} & \textbf{Type} &
    \textbf{ID} & \textbf{Event Name} & \textbf{Type} \\
    \hline
    I    & Carna         & Botnet                &
    X     & Reaper         & Botnet \\
    II   & Heartbleed    & Major Vulnerability    &
    XI    & VPNFilter      & Botnet \\
    III  & Shellshock    & Major Vulnerability    &
    XII   & Crackonosh     & Botnet \\
    IV   & Mirai         & Botnet                &
    XIII  & BlueKeep       & Major Vulnerability \\
    V    & Eternal Blue  & Major Vulnerability    &
    XIV   & Ripple20       & Major Vulnerability \\
    VI   & WannaCry      & Botnet                &
    XV    & SMBGhost       & Major Vulnerability \\
    VII  & BrickerBot    & Botnet                &
    XVI   & Log4JShell     & Major Vulnerability \\
    VIII & Amnesia       & Botnet                &
    XVII  & PrintNightmare & Major Vulnerability \\
    IX   & NotPetya      & Botnet                &
          &               &  \\
    \hline
    \end{tabular}
...
\begin{figure}[ht!]
    ...
    \caption{Timeframes and sources of darknet-traffic datasets used by detection methodology assessments, overlapped with dates of darknet-observable Internet-wide events (listed in Table~\ref{tab:events}).}
