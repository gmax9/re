...
This section provides a broad survey of methodologies that have been proposed for darknet-traffic analysis.
We review X works from the past Y years, categorizing them primarily based on the class of activity they target.
Within these 3 categories, we organize methods by the analytical subtasks they perform and briefly discuss each work in terms of 1) features of darknet-traffic they ingest and the 2) internal traffic representations on which their 3) general techniques and specific algorithms operate on to achieve such subtasks. 
...
We consider several characteristics of each dataset used to assess detection methodologies in prior work.
...
Some exceptions~\cite{2022kallitsis,2023kartsioukas} use known dates of landmark Internet-wide events, e.g., the Mirai botnet, to guide their selection of timeframes. 
In addition to Mirai, Figure 2 plots the start date of X additional events (further summarized in Table 5) identified as either major remote execution vulnerabilities or scans originated by botnets. 
...
the fact that X\% of events are covered by the timeframes of datasets used in method assessments.
...
% Sound comparisons between methods require that their assessments use shared reference datasets. 
% As 
...
\vspace{0.25em}
\noindent{\textbf{Standardized metrics}}
...
by differential metrics (e.g., Jaccard Index, etc.).
