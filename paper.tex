...
In this section, we provide a broad survey of existing darknet event detection frameworks selected to represent the spectrum of 
different analytical tasks and techniques; alongside, we review characteristics of their empirical evaluation to provide a\dots
\textit{discuss what high-level attributes of a detection framework we care about}
