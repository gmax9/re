...
In this section, we provide a broad survey of the methods that have been proposed for the detection of scanning activity in darknet traffic. 
We review 20 works from the past 10 years (summarized in Table~\ref{tab:methodologies}) and organize, for each work, detection methods by the key technique they employ. We briefly discuss components of each methodology's design before elaborating on individual methods.
...
\begin{table}[t]
    ...
    \begin{tabular}{l p{3cm} ccccccc p{2.2cm} cccc}
        \toprule
        \textbf{Work} &
        ...
        2025 Abduaziz et al. & Source Categorization & $\checkmark$ & $\checkmark$ & & & & & & & & & $\checkmark$ & \\
        2023 Kartsioukas et al. & Target Identification & & $\checkmark$ & & & $\checkmark$ & & & & & & & $\checkmark$ \\
        2023 Zakroum et al. (B) & Source Categorization  & $\checkmark$ & & $\checkmark$ & & & & & & & & & $\checkmark$ \\
        2022 Kallitsis et al. & Source Categorization & $\checkmark$ & $\checkmark$ & & $\checkmark$ & & & & & & $\checkmark$ & & \\
        2022 Zakroum et al. (A) & Target Identification & $\checkmark$ & & $\checkmark$ & & & & & & & & & $\checkmark$ \\
        2021 Han et al. & Source and Target Identif. & & $\checkmark$ & & & & & & & & & & $\checkmark$ \\
        2021 Gioacchini et al. & Source Categorization & $\checkmark$ & $\checkmark$ & & & & & & & & & $\checkmark$ & \\
        2020 Cohen et al. & Source and Target Identif. & & $\checkmark$ & & & & & & (TCP dest. port...) & & & & $\checkmark$ \\
        2020 Han et al. & Source and Target Identif. & & $\checkmark$ & & & & & & & & & & $\checkmark$ \\
        2020 Torabi et al. &  & & & & & & & $\checkmark$ & & $\checkmark$ & $\checkmark$ & & \\
        2020 Soro et al. & Source Categorization & $\checkmark$ & & & & & & & & & $\checkmark$ & & \\
        2019 Evrard et al. & Source Categorization & $\checkmark$ & & & & & & & & $\checkmark$ & & & \\
        2019 Iglesias et al. & Source Categorization & $\checkmark$ & & & & $\checkmark$ & & & & & $\checkmark$ & & \\
        2019 Niranjana et al. &  & $\checkmark$ & $\checkmark$ & & & & & & & $\checkmark$ & $\checkmark$ & $\checkmark$ & \\
        2019 Kanehara et al. & Source and Target Identif. & & $\checkmark$ & & & $\checkmark$ & & & & & & & $\checkmark$ \\
        2017 Lagraa et al. & Source Identification & $\checkmark$ & & & & & & & & $\checkmark$ & & & \\
        2016 Ban et al. & Source Identification & & $\checkmark$ & & & & & & & & & $\checkmark$ & $\checkmark$ \\
        2015 Nishikaze et al. & Source Categorization & $\checkmark$ & & & & & & & & & $\checkmark$ & & \\
...
\vspace{0.25em}
\noindent{\textbf{Detection tasks}} involve the identification of either senders of darknet traffic or targets that receive darknet traffic.
\maxnote{revise}
...
\vspace{0.25em}
\noindent{\textbf{Traffic features and representations}} \maxnote{revise}
...
One line of work proposes methdologies which apply thresholding and clustering techniques to graphical models of darknet traffic. 
Lagraa et al.~\cite{2017lagraa,2019lagraa} and Evrard et al.~\cite{2019evrard} model TCP scan traffic as unipartite graphs, \textit{i.e.}, nodes and edges represent respectively ports and consecutive port scans from the same sender).
% Lagraa et al. define graphs per individual sender, while 
...
\subsection{Time series dimensionality reduction methods}
