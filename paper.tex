...
One line of work proposes methdologies that rely on graphical models of darknet scan traffic.
% which represent darknet traffic using graphical models and apply thresholding/clustering techniques to identify similar groups of activities.
...
In 2019, Kanehara et al.~\cite{2019kanehara} proposed a method that applied Nonnegative Tucker Decomposition (NTD)~\cite{2015zhou} to time series of packet counts for each unique sender and their contacted destination ports.
