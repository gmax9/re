...
Here, we describe these components before elaborating on individual works.
...
\begin{table}[t]
    ...
    \setlength{\tabcolsep}{3pt} % Increased padding between all columns
    \begin{tabular}{l p{3.2cm} cccccc cccc p{2cm}}
        \toprule
        % High-level category alignment
        \textbf{Work} & 
        ...
        \cline{2-2} \cline{3-8} \cline{9-12} \cline{13-13}
        ...
        2025 Abduaziz et al.~\cite{2025abduaziz} & Source Categorization & $\checkmark$ & $\checkmark$ & & & & & & & $\checkmark$ & & \\

        % 2024 Enyanet et al. [37] & & $\checkmark$ & & $\checkmark$ & & & & & & & $\checkmark$ & \\

        2023 Kartsioukas et al.~\cite{2023kartsioukas}  & Target Identification & & $\checkmark$ & & $\checkmark$ & & & & & & $\checkmark$ & \\

        % 2023 Tanaka et al. [102, 103] & & & & & & & & $\checkmark$ & $\checkmark$ & $\checkmark$ & & \\

        2023 Zakroum et al. (B)~\cite{2023zakroum}  & Source Categorization  & $\checkmark$ & & $\checkmark$ & & & & & & & $\checkmark$ & \\

        2022 Kallitsis et al.~\cite{2022kallitsis} [62] & Source Categorization & $\checkmark$ & $\checkmark$ & & $\checkmark$ & & & & $\checkmark$ & & & \\

        2022 Zakroum et al. (A)~\cite{2022zakroum,2018zakroum}  & Target Identification & $\checkmark$ & & $\checkmark$ & & & & & & & $\checkmark$ & \\

        2021 Han et al.~\cite{2021han,2022han} & Source and Target Identification  & & $\checkmark$ & & & & & & & & $\checkmark$ & \\

        2021 Gioacchini et al.~\cite{2021gioacchini,2023gioacchini}  & Source Categorization & $\checkmark$ & $\checkmark$ & & & & & & & $\checkmark$ & & \\

        2020 Han et al.~\cite{2020han,2022han}  & Source and Target Identification & & $\checkmark$ & & & & & & & & $\checkmark$ & \\

        2020 Torabi et al.~\cite{2020torabi,2018torabi} & & & & & & & $\checkmark$ & $\checkmark$ & & & \\

        2020 Soro et al.~\cite{2020soro}  & Source Categorization & $\checkmark$ & & & & & & & $\checkmark$ & & \\

        2019 Evrard et al.~\cite{2019evrard}  & Source Categorization & $\checkmark$ & & & & & & $\checkmark$ & & & & \\

        2019 Iglesias et al.~\cite{2019iglesias} & Source Categorization & $\checkmark$ & & & $\checkmark$ & & & & $\checkmark$ & & & \\

        2019 Niranjana et al.~\cite{2019niranjana} &  & $\checkmark$ & $\checkmark$ & & & & & $\checkmark$ & $\checkmark$ & $\checkmark$ & & \\

        % 2019 Cabana et al. [22] & & $\checkmark$ & & & $\checkmark$ & & & $\checkmark$ & $\checkmark$ & & & \\

        2019 Kanehara et al.~\cite{2019kanehara,2022han} & Source and Target Identification & & $\checkmark$ & & $\checkmark$ & & & & & & $\checkmark$ & \\

        % 2019 Guillot et al. [50] & & $\checkmark$ & & $\checkmark$ & & & & & & & $\checkmark$ & \\

        % 2018 Shaikh et al. [98] & & & & & & & & & $\checkmark$ & & & \\

        2017 Lagraa et al.~\cite{2017lagraa,2019lagraa} & Source Identification & $\checkmark$ & & & & & & $\checkmark$ & & & & \\

        2016 Ban et al.~\cite{2016ban} & Source Identification & & $\checkmark$ & & & & & & & $\checkmark$ & $\checkmark$ & \\ 

        2015 Nishikaze et al.~\cite{2015nishikaze} & Source Categorization & $\checkmark$ & & & & & & & $\checkmark$ & & & \\
...
\vspace{0.25em}
\noindent{\textbf{Traffic representations and features}} 
...
Given a dataset, specific algorithms have the capability to automatically learn a lower-dimensional representation of raw data for downstream modeling tasks. 
Beginning in 2021, researchers began devising methodologies that leverage these techniques, often in combination with clustering techniques, to analyze darknet traffic.
Gioacchini et al.~\cite{2021gioacchini} proposed, \textit{DarkVec}, a domain-specific adaptation of Word2Vec to embed senders into vector spaces based on their order of arrival from packet sequences downstream clustering.
In later follow-up work, the same authors released \textit{i-DarkVec} which improved the original methodology to more scalably support larger volumes of traffic.
% In 2025, Abduaziz et al.~\cite{2025abduaziz} modify
...
\vspace{0.25em}
\noindent{\textbf{Graph-Mining Methods}}
