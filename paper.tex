...
More recently in 2024, Griffioen et al.~\cite{2024griffioen} conduct a 10-year longitudinal study and find a 30-fold increase in scan traffic\footnote{Griffioen et al. use their /16 darknet to draw comparisons.}
whose sources rapidly change geographic locations and port targets.
Between these studies, researchers also have studied alternative instrumentation for darknet traffic collection as IPv4 address space exhaustion pressures traditional darknet operation.
DScope~\cite{@@}, Metatelescope~\cite{@@}, and foundational works~\cite{@@}.
...
\begin{table}[t]
    ...
    \begin{tabular}{lccccccccccccccc p{2cm}}
        \toprule
        ...
        & \rot{90}{Thresholding/Fingerprinting} 
        & \rot{90}{Representation Learning} 
        & \rot{90}{Frequent Pattern Mining} 
