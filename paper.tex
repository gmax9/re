...
\begin{center}
    ...
    % \scriptsize
        ...
        % Lagraa et al.~\cite{2017lagraa,2019lagraa}             & \markX          & \markB        & \wc{Multiple}                     & \markD & Dst. Port \\
        Kallitsis et al.~\cite{2022kallitsis}                  & \markX,\markY   & \markA\markB  & \wc{Multiple}                     & \markE & Src. IP   \\
        % Iglesias et al.~\cite{2019iglesias}                    & \markX,\markY   & \markB        & Multiple clustering algorithms    & \markE & Src. IP   \\
        ...
        % Kanehara et al.~\cite{2019kanehara,2022han}            & \markX          & \markA\markH  & NTD    & \markG & Src. /16, Dst. Port \\
