...
Time series are widely used to monitor network traffic through a variety of metrics. 
Methods based on these representations analyze large collections of time series to 
identify specific time intervals that correspond to anomalous activity.
