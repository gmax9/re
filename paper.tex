...
\vspace{0.25em}
\noindent{\textbf{Activity Type(s)}} refers to the known classes of phenomena that a framework can capture based on explicitly stated design goals and empirical results.
...
\vspace{0.25em}
\noindent{\textbf{Algorithm(s)}} reference logic 
...
\noindent{\textbf{Side-by-side framework comparisons.}}
\begin{enumerate}
