...
\maxnote{revisit articulating this...}
...
In addition to Mirai, Figure~\ref{fig:cov_assess} plots the start date of X additional events (Table~\ref{tab:events}), observable in darknet traffic, identified as either major vulnerabilities or scans by botnets.
...
prior works rely on improvised approaches to validate method outputs. 
